...
using OpenSlide.Interop.Internal;
...
namespace OpenSlide.Interop
{
    ...
    public partial class OpenSlideImage : IDisposable
    {
        ...
        public double? MicronsPerPixelX
        {
            get
            {
                if (TryGetProperty(NativeMethods.MPP_X, out var value) && double.TryParse(value, out var result))
                {
                    return result;
                }
                return null;
        ...
        public double? MicronsPerPixelY
        {
            get
            {
                if (TryGetProperty(NativeMethods.MPP_Y, out var value) && double.TryParse(value, out var result))
                {
                    return result;
                }
                return null;
