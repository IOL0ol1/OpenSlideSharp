...
namespace OpenSlide.Interop.Internal
{
    /// <summary>
    ...
    public static class NativeMethods
    {
        ...
        [DllImport(LibraryName, EntryPoint = "openslide_detect_vendor", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8StringMarshaler))]
        public extern static string DetectVendor(string filename);
        ...
        /// </returns>
        [DllImport(LibraryName, EntryPoint = "openslide_open", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8StringArrayMarshaler))]
        ...
        ///</return> 
        [DllImport(LibraryName, EntryPoint = "openslide_get_property_value", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8StringMarshaler))]
        public extern static string GetPropertyValue(IntPtr osr, string name);
        ...
        [DllImport(LibraryName, EntryPoint = "openslide_get_associated_image_dimensions", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        ///<param name="dest">The destination buffer for the ARGB data.</param> 
        ///
        [DllImport(LibraryName, EntryPoint = "openslide_read_associated_image", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    /// <summary>
    /// char** to UTF8 string array marshaler
    /// </summary>
    public class UTF8StringArrayMarshaler : ICustomMarshaler
    {
        ...
        public unsafe object MarshalNativeToManaged(IntPtr pNativeData)
        {
            ...
            for (int arrayLength = 0; ; arrayLength++)
            {
                if (arrayPtr[arrayLength] != null)
                    output.Add(UTF8StringMarshaler.GetInstance("").MarshalNativeToManaged((IntPtr)arrayPtr[arrayLength]) as string);
                else
        ...
        /// <returns></returns>
        public static ICustomMarshaler GetInstance(string cookie) => new UTF8StringArrayMarshaler();
    }


    /// <summary>
    /// char* to UTF8 string marshaler.
    /// </summary>
    public class UTF8StringMarshaler : ICustomMarshaler
    {
        ...
        public unsafe object MarshalNativeToManaged(IntPtr pNativeData)
        {
            ...
            for (int arrayLength = 0; ; arrayLength++)
            {
                if (str[arrayLength] == 0)
                    return new string(str, 0, arrayLength, Encoding.UTF8);
            }
        }
        ...
        /// <param name="cookie"></param>
        /// <returns></returns>
        public static ICustomMarshaler GetInstance(string cookie) => new UTF8StringMarshaler();
    }
}
